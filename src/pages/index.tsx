                ...
                <Box ml={{ mobile: 0, laptop: '100px' }}>
                    ...
                    <Box component="div" id="how-it-work" display="flex" flexDirection="column" mt="10%">
                        <Box textAlign="center" display="flex" flexDirection="column" gap={2} alignItems="center">
                            ...
                            <Typography variant="h3" fontWeight="bold" color="primary" width={{ mobile: '100%', laptop: '50%' }}>
                                Highest standards made just for you.
                            </Typography>
                            <Typography variant="body1" color="#737373" width={{ mobile: '100%', laptop: '30%' }}>
                        ...
                        >
                            ...
                            >
                                <Box display="flex" flexDirection="row" alignItems="center" minWidth={200} gap={2}>
                    ...
                    >
                        ...
                        >
                            <Box>
                                ...
                                <Typography variant="h4" fontWeight="bold" color="primary" width={{ mobile: '100%', laptop: '70%' }}>
                                    Enjoy our online courses for free
                                </Typography>
                                <Typography variant="body1" color="#737373" width={{ mobile: '100%', laptop: '70%' }}>
                    ...
                    >
                        ...
                        >
                            <Box>
                                ...
                                <Typography variant="body1" color="#737373" width={{ mobile: '100%', laptop: '65%' }}>
