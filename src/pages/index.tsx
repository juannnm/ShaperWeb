    ...
    return (
      <div>
        ...
        <Box component="main">
          ...
          <Box component="div" id="Paths" sx={{ m: "50px" }}>
            <Box
              width="65vw"
              display="flex"
              flexDirection="row"
          ...
          {/* Here it should have a Calendar, the EventCards should be able to scroll down and the cards have a problem with padding */}
          <Box
            component="div"
            id="Events"
            sx={{
          ...
          >
            <Box display="flex" flexDirection="row">
              ...
              <Typography variant="body1">
                ...
                improve your skills to help you succeed in your job search.
              </Typography>
            </Box>
            <Box  display="flex" flexDirection="row">
              <Box>
