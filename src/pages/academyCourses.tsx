        ...
        <Box display="flex" flexDirection="row" justifyContent='center'>
          ...
          <Box justifyContent="center" alignItems="center" ml='35px' mt='10px'>
            <Typography variant='h4'>
              You will be able to learn the most<br/> useful methods and techniques
            </Typography>
            <Typography>
              On the market in high quality, so you will not miss a<br /> single
              detail, without limitations.
            </Typography>
          </Box>
        </Box>
        <Box display="flex" flexDirection="row" justifyContent='center'>
