    ...
    return (
        <div>
            ...
            <Box component="main" sx={{ background: 'linear-gradient(180deg, #050E3F 0%, #A54CDB 100%);' }}>
                ...
                <Box display="flex" justifyContent="center" pt="10%" alignItems="center" pb="10%">
                ...
                <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap={10} pb="10%">
                ...
                <Box display="flex" justifyContent="center" alignItems="center" gap="10%" mb="10%" mt="10%">
                    <Box display="flex" flexDirection="column">
