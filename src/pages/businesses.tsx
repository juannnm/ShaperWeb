    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <Box display="flex" flexDirection="column">
                        ...
                        <Typography align="justify" color="white">
                            ...
                            confidential project that meets your needs to prove how hard they work and evaluate them in the process. This way you get
                            real-work data and new candidates for your company.
                        </Typography>
                    </Box>
                ...
                <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap={10} pb="10%" m={{ mobile: '0 10%' }}>
                    ...
                    <Box display="flex" alignItems="center" gap="10%">
                        ...
                        <Box>
                            ...
                            <Typography variant="body1" sx={{ whiteSpace: 'pre-line' }} color="white" maxWidth={400}>
                ...
                <Box display="flex" justifyContent="center" alignItems="center" flexWrap={{ mobile: 'wrap-reverse' }} m={{ mobile: '0 10%' }}>
                    <Box display="flex" flexDirection="column">
                        <Typography variant="h6" color="white" fontWeight="bold">
                            UNIVERSITIES
                        </Typography>
                        ...
                        <Typography align="justify" sx={{ whiteSpace: 'pre-line' }} color="white">
                            Students can join our network to start a new career path and meet some of the best employers in the industry by applying
                            for internships, apprenticeships and graduate placements.
                        </Typography>
                    </Box>
                ...
                <Box display="flex" justifyContent="center" alignItems="center" gap="10%" m={{ mobile: '0 10%', desktop: '10% 0' }}>
                    <Box display="flex" flexDirection="column">
                        ...
                        <Typography align="justify" sx={{ whiteSpace: 'pre-line' }} color="white">
                            Benefit from innovative teaching and credentials that employers value - all with the flexibility and value they need for
